...
전체 사진 검수에서 `검토 필요/실패`로 남은 인물을 운영자가 실제로 복구할 수 있도록 문제 항목 일괄 자동 복구, 인물별 자동 복구, 전 정치인 직접 사진 등록/교체 기능을 추가했습니다. 자세한 내용은 `README_V2_2_18_PHOTO_AUDIT_RECOVERY.md`를 참고하세요.
