...
function carryNumeric(summary,factor){
  const out={...(summary||{})};
  for(const k of ['count6','count24','count7d','sources6','sources24','event6','title6','surfaceHits','nameHits','eventHits','freshHits','score','traffic','views6','views24','views7d','totalCount','level7d','level30d','recent3','prior14','monthlyPcQcCnt','monthlyMobileQcCnt','monthlyTotalQcCnt']){
