...
module.exports=async function(req,res){
  ...
  const b=req.body||{};
  try{
    const user=await createUser({email:b.email,password:b.password,nickname:b.nickname,agreeTerms:b.agreeTerms===true,agreePrivacy:b.agreePrivacy===true,age14:b.age14===true});
